...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Sign in — Compassion Bridge" },
      { name: "description", content: "Sign in to manage your medical fundraising campaign on Compassion Bridge." },
    ],
  }),
  component: LoginPage,
});
  ...
  return (
    <Layout>
      <section className="mx-auto flex max-w-md flex-col px-4 py-16 md:py-24">
        ...
        <p className="mt-2 text-muted-foreground">Sign in to manage your campaign.</p>
